...
- [ ] 1.1 [3/10] Add priority field to todo data model
...
- [ ] 1.2 [4/10] Add reactive priority state variable
...
- [ ] 1.3 [5/10] Update addTodo function to handle priority
...
- [ ] 2.1 [6/10] Add priority selector dropdown to input section
...
- [ ] 2.2 [5/10] Add priority badge display to todo items
...
- [ ] 2.3 [5/10] Style priority selector dropdown
...
- [ ] 2.4 [5/10] Style priority badges with color coding
...
- [ ] 3.1 [5/10] Implement priority-based sorting
